...
summary: WebAssembly Core MVP plus sign-extension, full bulk-memory, non-trapping float-to-int, reference types, and multi-memory — runs real rustc-built wasm32-wasip1 binaries end-to-end through a 24-syscall WASI Preview 1 shim. Zero runtime dependencies across JVM, Scala.js, and Scala Native.
---
...
**476 tests** on the JVM (310 interpreter + 157 WASI + 9 CLI), all green; the interpreter and WASI test suites also pass on Scala.js and Scala Native.
