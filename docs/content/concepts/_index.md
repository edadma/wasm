...
- [ModuleInstance](/concepts/module-instance/) — what `Runtime.instantiate` returns and the public surface for invoking exports, reading globals, and touching linear memory.
